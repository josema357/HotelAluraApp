...
import com.josema.controlador.UsuarioController;
...
public class Login extends JFrame {
	...
	public Login() {
		...
		imgHotel.setIcon(new ImageIcon(Login.class.getResource("/com/josema/imagenes/img-hotel-login-.png")));
		...
		labelTitulo.setBounds(65, 149, 230, 26);
		...
		LabelUsuario.setBounds(65, 219, 324, 26);
		...
		lblContrasea.setBounds(65, 316, 324, 26);
		...
		lblNewLabel_1.setIcon(new ImageIcon(Login.class.getResource("/com/josema/imagenes/lOGO-50PX.png")));
	...
	private void loginApp() {
		...
		String passUsuario=new String(txtContrasena.getPassword());
	
		UsuarioController controller=new UsuarioController();
		boolean login = controller.iniciarSesion(nombreUsuario, passUsuario);
		...
		if(login) {
			...
			JOptionPane.showMessageDialog(contentPane, "Usuario o Contraseña no válidos");
		}
	}    
