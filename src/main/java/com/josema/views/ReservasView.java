...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		super("Reserva");
		setIconImage(Toolkit.getDefaultToolkit().getImage(ReservasView.class.getResource("/com/josema/imagenes/aH-40px.png")));
		...
		separator_1_1.setBounds(68, 281, 289, 2);
		...
		lblTitulo.setBounds(64, 60, 293, 42);
		...
		panel_1.add(logo);
		logo.setIcon(new ImageIcon(ReservasView.class.getResource("/com/josema/imagenes/Ha-100px.png")));
		
		JLabel imagenFondo = new JLabel("");
		imagenFondo.setBounds(0, 140, 500, 409);
		panel_1.add(imagenFondo);
		imagenFondo.setBackground(Color.WHITE);
		imagenFondo.setIcon(new ImageIcon(ReservasView.class.getResource("/com/josema/imagenes/reservas-img-3.png")));
		...
		txtFechaEntrada.getCalendarButton().setIcon(new ImageIcon(ReservasView.class.getResource("/com/josema/imagenes/icon-reservas.png")));
		...
		txtFechaSalida.getCalendarButton().setIcon(new ImageIcon(ReservasView.class.getResource("/com/josema/imagenes/icon-reservas.png")));
		...
		lblSiguiente_1.setForeground(new Color(255, 255, 255));
	...
	//Código que permite mover la ventana por la pantalla según la posición de "x" y "y"	
	 ...
	 private void saveReserva() {
		 ...
		 Reserva nuevaReserva=new Reserva(dateEntrada, dateSalida, valorReserva, formaPago);
		 controller.save(nuevaReserva);
